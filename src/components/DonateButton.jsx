...
function DonateButton() {
  return (
    ...
    <form action="https://www.paypal.com/donate" method="post" target="_top">
      <input type="hidden" name="hosted_button_id" value="L8QFTGV5HT492" />
      <input type="image" src="https://viatesting.files.wordpress.com/2020/03/paypal-donate-button.png" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" />
    </form>
